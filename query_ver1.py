...
def query(tf,docFreq,map_id_doc,pathquery):
    ...
    for t in list_queries:
        ...
        # Document Frequency
        #
        # Calculating Doc Freq for each term in the query. The intersection of the logically
        # matched docs and the pre-computed ground document frequency for the term. 
